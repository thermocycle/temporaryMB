...
parameter Real k_Mass_rec = 1;
  ...
  ThermoCycle.Components.Units.HeatExchangers.Hx1DConst eva(
    ...
    annotation (Placement(transformation(extent={{-38,16},{-2,54}})));
...
//  m_outflow = eva.outletWf.m_flow;
  ...
  connect(sourceMdot.flangeB, eva.inletWf) annotation (Line(
      points={{-63,8},{-56,8},{-56,24},{-38,24},{-38,25.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sourceCdot.flange, eva.inletSf) annotation (Line(
      points={{36.2,89.9},{36,89.9},{36,44.5},{-2,44.5}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(boundaryEva.h, sourceMdot.in_h) annotation (Line(
      points={{-42.1,84.1},{-66,84.1},{-66,14}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(eva.outletWf, sensTp.InFlow) annotation (Line(
      points={{-2,25.5},{10,25.5},{10,7.2},{29,7.2}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sensTp.OutFlow, sinkP.flangeB) annotation (Line(
      points={{43,7.2},{48,7.2},{48,-30},{69.6,-30}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(boundaryEva.p, sinkP.in_p0) annotation (Line(
      points={{-20.1,87.1},{-2,87.1},{-2,60},{74,60},{74,-21.2}},
      color={0,0,127},
      smooth=Smooth.None));
