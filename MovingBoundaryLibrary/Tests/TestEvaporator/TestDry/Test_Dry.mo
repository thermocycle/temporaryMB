...
model Test_Dry
 ...
 Components.Evaporator.Unit.EvaDw evaD(
    ...
    Tstartsf=1473.15,
    DTstartsf=323.15) annotation (Placement(transformation(extent={{-20,-6},{30,38}})));
...
equation
  connect(sourceMdot2.flangeB, evaD.InflowPF)
    annotation (Line(
      points={{-65,-8},{-42,-8},{-42,2.8},{-19,2.8}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(evaD.OutflowPF, sinkP1.flangeB)
    annotation (Line(
      points={{29,2.8},{52,2.8},{52,0},{81.6,0}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(sourceCdot.flange, evaD.InFlowSF)
    annotation (Line(
      points={{40.2,59.9},{60,59.9},{60,28.76},{29,
          28.76}},
      color={255,0,0},
      smooth=Smooth.None));
