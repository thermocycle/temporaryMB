...
model Test_evaWaterUnit
 ...
 Components.Evaporator.Unit.EvaGw evaG(
    ...
    Tstartsf=1273.15,
    DTstartsf=323.15) annotation (Placement(transformation(extent={{-24,-36},{26,14}})));
