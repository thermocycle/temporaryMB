...
model GeneralBonilla
 ...
 annotation (Placement(transformation(extent={{-36,-104},{40,-40}},
  ...
  Modelica.Blocks.Sources.RealExpression Pipe_Surface_SS(y=
        ...
        extent={{-94,-43},{-54,-21}},
                                    rotation=0)));
  Modelica.Blocks.Sources.RealExpression Outlet_pressure(y=pout)
                                 annotation (Placement(transformation(
        extent={{56,-54},{74,-37}}, rotation=0)));
...
equation
  ...
  connect(sink.p_in,Outlet_pressure. y) annotation (Line(
      points={{82,-80},{90,-80},{90,-45.5},{74.9,-45.5}},
      color={0,0,127},
      thickness=0.5,
      smooth=Smooth.None));
  connect(sink.ports[1], GeneralEvaporator.b) annotation (Line(
      points={{60,-72},{40,-72}},
      color={0,127,255},
      thickness=0.5,
      smooth=Smooth.None));
