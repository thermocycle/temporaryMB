...
replaceable package Medium =
  ...
  Components.Evaporator.Incompressible.Unit.EvaGwInc
    evaGw(
...
equation
  connect(sourceCdot.flange, evaGw.InFlowSF) annotation (Line(
      points={{-13.8,71.9},{52,71.9},{52,14},{22,14},{
          22,14.4},{21.48,14.4}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(sourceMdot.flangeB, evaGw.InFlowPF) annotation (Line(
      points={{-63,-54},{-50,-54},{-50,-20.4},{-29.48,-20.4}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(evaGw.OutFlowPF, sinkP.flangeB) annotation (Line(
      points={{21.48,-19.82},{40,-19.82},{40,-54},{73.6,-54}},
      color={0,0,255},
      smooth=Smooth.None));
