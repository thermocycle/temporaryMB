...
model Test_FloodedUnitPdrop_TC
 ...
 Components.Evaporator.Unit.EvaFw evaF(
    ...
    Tstartsf=523.15,
    DTstartsf=323.15) annotation (Placement(transformation(extent={{-18,-20},{
            22,30}})));
...
equation
  connect(sourceCdot.flange, evaF.InFlowSF)
    annotation (Line(
      points={{26.2,83.9},{40,83.9},{40,25},{20.8,25}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(sourceMdot2.flangeB, evaF.InflowPF)
    annotation (Line(
      points={{-61,-20},{-48,-20},{-48,-15},{-18,-15}},
      color={0,0,255},
      smooth=Smooth.None));
...
// 1000        0.000167529
  ...
  connect(evaF.OutflowPF, valve.InFlow) annotation (Line(
      points={{21.6,-14.5},{36,-14.5},{36,-12},{49,-12}},
      color={0,0,255},
      smooth=Smooth.None));
