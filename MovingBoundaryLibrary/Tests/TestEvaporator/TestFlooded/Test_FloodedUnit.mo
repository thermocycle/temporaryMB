...
parameter Boolean counterCurrent = true;
  Components.Evaporator.Unit.EvaFw evaF(
    ...
    Tstartsf=523.15,
    DTstartsf=323.15) annotation (Placement(transformation(extent={{-16,-16},{24,34}})));
equation
...
if counterCurrent then
  ...
  connect(sourceCdot.flange, evaF.InFlowSF)
    annotation (Line(
      points={{26.2,83.9},{40,83.9},{40,29},{22.8,
          29}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(sourceMdot2.flangeB, evaF.InflowPF)
    annotation (Line(
      points={{-61,-20},{-48,-20},{-48,-11},{-16,-11}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(evaF.OutflowPF, sinkP1.flangeB)
    annotation (Line(
      points={{23.6,-10.5},{71.6,-10.5},{71.6,-10}},
      color={0,0,255},
      smooth=Smooth.None));
