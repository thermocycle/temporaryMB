...
parameter Real k_Mass_rec = 1;
 ...
 ParametrizedModels.PdropHP_143 pdropHP_143_1(redeclare package Medium =           Medium)
  ...
  ThermoCycle.Components.Units.HeatExchangers.Hx1DConst Condenser(redeclare
    ...
    annotation (Placement(transformation(extent={{16,-80},{-18,-110}})));
  ThermoCycle.Components.FluidFlow.Reservoirs.SourceCdot sourceCdot2(
    Mdot_0=1.546,
    cp=4183,
    rho=1000,
    T_0=295.54)
    annotation (Placement(transformation(extent={{-56,-138},{-36,-118}})));
equation
  ...
  connect(Recuperator.outlet_fl2, Condenser.inletWf) annotation (Line(
      points={{9.28,-47.68},{9.28,-56},{58,-56},{58,-88},{34,-88},{34,-87.5},{16,
          -87.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sinkP1.flangeB, Condenser.outletWf) annotation (Line(
      points={{-85.6,-94},{-66,-94},{-66,-98},{-48,-98},{-48,-87.5},{-18,-87.5}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(sourceCdot2.flange, Condenser.inletSf) annotation (Line(
      points={{-37.8,-128.1},{-28,-128.1},{-28,-102.5},{-18,-102.5}},
      color={255,0,0},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -140},{140,120}}), graphics), Icon(coordinateSystem(extent={{-120,-140},
            {140,120}})),
