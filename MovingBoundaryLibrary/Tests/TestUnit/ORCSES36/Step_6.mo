...
parameter Real k_Mass_rec = 1;
 ...
 ParametrizedModels.PdropHP_143 pdropHP_143_1(redeclare package Medium =           Medium)
  ...
  Components.Condenser.Unit.CondFw condFw(redeclare package Medium = Medium,
    AA=0.0007,
    YY=0.243,
    Ltotal=66.6,
    cpw=500,
    ...
    DTstartsf=278.15,
    Set_h_pf_out=true)
    annotation (Placement(transformation(extent={{30,-74},{-16,-118}})));
...
equation
  ...
  connect(sourceCdot1.flange, condFw.InFlowSF) annotation (Line(
      points={{-51.8,-108.1},{-33.9,-108.1},{-33.9,-113.6},{-14.62,
          -113.6}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(sinkP.flangeB, condFw.OutflowPF) annotation (Line(
      points={{-61.6,-84},{-38,-84},{-38,-78.84},{-15.54,-78.84}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Recuperator.outlet_fl2, condFw.InflowPF) annotation (Line(
      points={{9.28,-47.68},{9.28,-52},{50,-52},{50,-78.4},{30,-78.4}},
      color={0,0,255},
      smooth=Smooth.None));
