...
model Plant_DownUp_5hz_MB_1_vf_N1
...
parameter Real k_Mass_rec = 1;
 ...
 ParametrizedModels.PdropHP_143 pdropHP_143_1(redeclare package Medium =           Medium)
  ...
  ThermoCycle.Components.Units.HeatExchangers.Hx1DConst Condenser(
    ...
    annotation (Placement(transformation(extent={{32,-94},{2,-124}})));
...
ParametrizedModels.Tank             tank_pL(
    ...
    annotation (Placement(transformation(extent={{-66,-112},{-42,-88}})));
...
equation
  ...
  connect(Recuperator1.outlet_fl2, Condenser.inletWf) annotation (Line(
      points={{-12.72,-41.68},{-12.72,-64},{78,-64},{78,-88},{32,-88},{
          32,-101.5}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(sourceCdot2.flange,Condenser. inletSf) annotation (Line(
      points={{-33.8,-142.1},{-10,-142.1},{-10,-116.5},{2,-116.5}},
      color={255,0,0},
      smooth=Smooth.None));
  ...
  connect(tank_pL.InFlow, Condenser.outletWf) annotation (Line(
      points={{-54,-89.92},{-54,-74},{2,-74},{2,-101.5}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(pump.InFlow, tank_pL.OutFlow) annotation (Line(
      points={{-119.8,-62.25},{-140,-62.25},{-140,-126},{-54,-126},{-54,-110.56}},
      color={0,0,255},
      smooth=Smooth.None));
...
end Plant_DownUp_5hz_MB_1_vf_N1;
