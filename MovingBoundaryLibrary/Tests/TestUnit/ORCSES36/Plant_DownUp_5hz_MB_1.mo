...
ParametrizedModels.Tank             tank_pL(
    ...
    annotation (Placement(transformation(extent={{-66,-122},{-42,-98}})));
...
equation
  ...
  connect(expander.flange_elc, generator.shaft) annotation (Line(
      points={{72,29},{84,29},{84,28},{97.4,28}},
      color={0,0,0},
      smooth=Smooth.None));
  ...
  connect(tank_pL.InFlow, Condenser.outletWf) annotation (Line(
      points={{-54,-99.92},{-50,-99.92},{-50,-80},{2,-80},{2,-79.5}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(Pump.InFlow, tank_pL.OutFlow) annotation (Line(
      points={{-119.8,-62.25},{-140,-62.25},{-140,-134},{-54,-134},{-54,-120.56}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(f_pump.y, Pump.flow_in) annotation (Line(
      points={{-145,-22},{-113.8,-22},{-113.8,-51}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(orcMassFlow.M_dot_orc, Pump.M_dot_ext) annotation (Line(
      points={{-120,20.2},{-116,20.2},{-116,20},{-107.95,20},{-107.95,-50.25}},
      color={0,0,127},
      smooth=Smooth.None));

  connect(Tcf_cd_su.y, sourceCdot2.T_source) annotation (Line(
      points={{-85,-152},{-62,-152},{-62,-144.1},{-49.3,-144.1}},
      color={0,0,127},
      smooth=Smooth.None));
