within MovingBoundaryLibrary.Tests.TestUnit.ORCSES36.Validation;
...
ParametrizedModels.Tank             tank_pL(
  ...
  ThermoCycle.Components.HeatFlow.Sensors.SensTp SensorExpRec(redeclare package
      Medium =         Medium) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={10,24})));
  Components.Evaporator.Incompressible.Unit.EvaGwInc evaGw(
    redeclare package Medium = Medium,
    Ltotal=66.6,
    AA=0.0007,
    YY=0.243,
    ...
    Tstartsf=398.15,
    DTstartsf=278.15) annotation (Placement(transformation(extent={{
            -60,50},{-10,90}})));
equation
