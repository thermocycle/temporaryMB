within MovingBoundaryLibrary.Tests.TestCondenser.TestFlooded;
...
equation
  connect(sourceCdot1.flange, condFw.InFlowSF) annotation (Line(
      points={{26.2,55.9},{54,55.9},{54,35.6},{16.62,35.6}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(sourceMdot.flangeB, condFw.InflowPF) annotation (Line(
      points={{-61,-12},{-50,-12},{-50,0.4},{-28,0.4}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(condFw.OutflowPF, sinkP.flangeB) annotation (Line(
      points={{17.54,0.84},{38,0.84},{38,-30},{49.6,-30}},
      color={0,0,255},
      smooth=Smooth.None));
