within MovingBoundaryLibrary.Tests.TestCondenser.TestGeneral;
...
replaceable package Medium =
  ...
  Components.Condenser.Unit.CondGw condGw(redeclare package Medium = Medium,
    AA=0.0007,
    YY=0.243,
    Ltotal=66.6,
    cpw=500,
...
equation
  connect(sourceCdot1.flange, condGw.InFlowSF) annotation (Line(
      points={{26.2,55.9},{54,55.9},{54,13.2},{25.54,13.2}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(condGw.InFlowPF, sourceMdot.flangeB) annotation (Line(
      points={{-19.54,-13.2},{-22,-13.2},{-22,-12},{-61,-12}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(condGw.OutFlowPF, sinkP.flangeB) annotation (Line(
      points={{25.54,-12.76},{34,-12.76},{34,-30},{49.6,-30}},
      color={0,0,255},
      smooth=Smooth.None));
