within MovingBoundaryLibrary.Tests.ComparisonSolarField;
...
parameter Boolean counterCurrent = true;
  ...
  Components.Evaporator.EvaGeneral
    evaGeneral(
  ...
  Components.Wall.Receiver
    receiver(T_amb(displayUnit="K") = 290, epsilon=0.1)
