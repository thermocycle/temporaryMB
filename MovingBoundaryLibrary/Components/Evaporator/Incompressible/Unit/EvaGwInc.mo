within MovingBoundaryLibrary.Components.Evaporator.Incompressible.Unit;
model EvaGwInc
...
equation
  ...
  connect(Wall.QmbIn, evaGeneral.mbOut)
    annotation (Line(
      points={{-1.6,-16.2},{-1.6,-32},{0,-32},{0,-60}},
      color={0,0,0},
      smooth=Smooth.None));
...
equation
  connect(InFlowPF, evaGeneral.InFlow) annotation (Line(
      points={{-98,-60},{-66,-60},{-66,-82},{-40.8,-82},{-40.8,-77.6}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(evaGeneral.OutFlow, OutFlowPF) annotation (Line(
      points={{39.2,-77.6},{54,-77.6},{54,-60},{86,-60},{86,-58},{98,
          -58}},
      color={0,0,255},
      smooth=Smooth.None));
