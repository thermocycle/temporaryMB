within MovingBoundaryLibrary.Components.Cells;
...
/************ Thermal and fluid ports ***********/
 ...
 ThermoCycle.Interfaces.Fluid.FlangeB outFlow(redeclare final package Medium =
  ...
  Interfaces.MbOut mbOut annotation (Placement(transformation(extent={{-10,80},{10,100}})));
...
public
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
       ...
       <p><big>The assumptions for this model are:
         ...
         <li> Dynamic energy and mass balance, static momentum balance are considered.
         <li>The velocity of the fuid is uniform over the cross sectional area. Homogeneous two-phase flow.
         ...
         <li> Thermal energy transfer in the fluid due to heat conduction is neglected.
...
<p>
<img src=\"modelica://MovingBoundary/Resources/Images/RateMass_TP.png\">
</p> 

<p><big> The rate of energy change for the two-phase flow is defined as:
<p>
<img src=\"modelica://MovingBoundary/Resources/Images/RateEnergy_TP.png\">
</p> 
...
<p>
<img src=\"modelica://MovingBoundary/Resources/Images/AveVoidFrac.png\">
</p> 
