...
\newglossaryentry{N}{name={\ensuremath{N}},description={Number of sections (ND)}}
\newglossaryentry{h}{name={\ensuremath{h}},description={Heat transfer coefficient (\si{\watt\per\square\metre\per\kelvin})}}
...
name={\Nu},
description={Nusselt number: $\frac{\text{convection}}{\text{conduction}} = \frac{\gls{h}\,\gls{L}}{\gls{lambda}}$},  
%text={\Nu},
...
% and subscripts
\newglossaryentry{sub:r}{type=subscripts,name={r},description={refrigerant, working fluid}}
