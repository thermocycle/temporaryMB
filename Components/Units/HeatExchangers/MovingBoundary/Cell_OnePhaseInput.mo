...
model Cell_OnePhaseInput "1-D lumped fluid flow model (Real fluid model)"
...
/***************  VARIABLES ******************/
 ...
 // Medium.ThermodynamicState State1;
  ...
  Real Dz_a;
  Real Dz_b;
  //Real q_dot "heat flow per unit of length";
 ...
 Real epsilon;
  ...
  Modelica.Blocks.Interfaces.RealInput q_dot
