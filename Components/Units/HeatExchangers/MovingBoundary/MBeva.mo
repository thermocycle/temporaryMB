...
/***************** PORTS ******************/
  ...
  MBportTotal MB_port
    annotation (Placement(transformation(extent={{-40,14},{50,92}})));
...
Modelica.SIunits.Temperature TwB
    "Wall Temperature at the interface between two-phase and sub-cooled";
Modelica.SIunits.Temperature TwSH
    "Mean Wall Temperature in the superHeated Region";
...
h_TP = (h_LS + h_VS)/2 "Mean enthalpy of the two-phase region";
