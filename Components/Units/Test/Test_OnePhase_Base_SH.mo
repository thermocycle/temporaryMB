...
model Test_OnePhase_Base_SH
replaceable package Medium = ThermoCycle.Media.Water;
  HeatExchangers.MovingBoundary.Cell_OnePhase_Base_SH
...
equation
  ...
  connect(ramp.y,firstOrder. u) annotation (Line(
      points={{-93,64},{-90,64},{-90,38},{-86,38}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(firstOrder.y, sourceP.in_h) annotation (Line(
      points={{-63,38},{-60,38},{-60,36},{-58,36},{-58,10},{-80,10},{-80,-3},{
          -84,-3}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            -100},{100,100}}), graphics));
end Test_OnePhase_Base_SH;
